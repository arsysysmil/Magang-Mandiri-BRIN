<h1 align="center">SIMULASI MoS₂ DUA DIMENSI UNTUK APLIKASI SENSOR GAS</h1>

<p align="center">
  <img src="https://img.shields.io/badge/Status-Completed-success" alt="Status">
  <img src="https://img.shields.io/badge/Method-DFT-blue" alt="Method">
  <img src="https://img.shields.io/badge/Engine-Quantum_ESPRESSO-orange" alt="Engine">
</p>
...
1. **Pemodelan Sistem (Modeling):** Konstruksi *supercell* $4\times4$ monolayer $MoS_2$ (total 48 atom) dengan penambahan ruang vakum 20 Å untuk mengisolasi lapisan 2D.
2. **Optimasi Geometri (Relaxation):** Pencarian konfigurasi adsorpsi paling stabil pada situs *Hollow, Top-Mo, Top-S,* dan *Bridge*.
3. **Analisis Energi (Energetics):** Perhitungan Energi Adsorpsi ($E_{ads}$) untuk menentukan jenis interaksi (Fisisorpsi vs Kemisorpsi).
4. **Struktur Elektronik (Electronic Properties):** Analisis perubahan *Density of States* (DOS) dan *Band Structure* untuk mendeteksi *impurity states* di celah pita energi.

---

## Temuan Kunci (Key Findings)
> Material $MoS_2$ terbukti memiliki **selektivitas tinggi terhadap $NO_2$**, ditandai dengan energi adsorpsi yang signifikan dan munculnya *state* elektronik baru di area *band gap*, berbeda dengan respon lemah terhadap gas lain seperti $CO$ atau $H_2$.
...
| **Visualisasi Struktur** | VESTA, XCrySDen |
...
* **[Laporan_Magang_BRIN_Arsy.pdf](Laporan_Magang_BRIN_Arsy.pdf)**
...
## Penulis
**Arsy Syamil Hananan Taqiyya** (NIM: 101042330067)
